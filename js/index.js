...
function refreshCanvas(){
    ...
    if(snakee.checkCollision()){
        ...
        snakee.draw();
        applee.draw();
        timeOut = setTimeout(refreshCanvas,deplay);
    }
}
function gameOver(){
    ctx.save();
...
function Snake(body, direction){
    ...
    this.checkCollision = function(){
        ...
        let isNotBetweenverticaltalWalls = snakeY < minY || snakeY > maxY;
        if(isNotBetweenHorizontalWalls || isNotBetweenverticaltalWalls){
            wallCollision = true;
        }
